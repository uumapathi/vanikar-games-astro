...
const universalGames: Game[] = [
  ...
  },
  {
    ...
    playGuide: [
      {
        heading: 'Setting up your table',
        points: [
          'Bluff seats 2 to 6 — one human plus up to five AI opponents — though it comes alive with four or more, where there is enough doubt to hide a lie in.',
    ...
    screenshots: [
      { file: 'bluff/01-game-setup.png',  title: 'Set up the table',   caption: 'Bluff seats 2–6 — add AI opponents and deal the whole deck out.' },
  ...
  },
  {
    ...
    setup: [
      'Use a standard 52-card deck. Deal 7 cards each in a two-player game, or 5 cards each with three or more.',
    ...
    playGuide: [
      {
        heading: 'Setup and the deal',
        points: [
          'Crazy Eights uses a standard 52-card deck and seats 2 to 8 players. Deal 5 cards each with three or more players, or 7 in a two-player game.',
...
const latinAmericaGames: Game[] = [
  {
    ...
    setup: [
      ...
      '2 to 4 players. At four they play as two partnerships sitting opposite each other. Deal 11 cards each.',
    ...
    playGuide: [
      {
        heading: 'Setup and the deal',
        points: [
          'Canasta uses two full decks plus four Jokers — 108 cards — and seats 2 to 4 players. At four, partners sit opposite each other and melds belong to the partnership.',
  ...
  },
  {
    ...
    setup: [
      'Uses 2 standard decks + 4 jokers (108 cards). 2 to 4 players; at four they play as two teams.',
...
const asiaGames: Game[] = [
  {
    ...
    setup: [
      'Use a standard 52-card deck. Deal 13 cards to each player, with 2 to 4 at the table.',
